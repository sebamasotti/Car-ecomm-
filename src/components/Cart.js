        ...
        >
            ...
            {test.cartList.length > 0 && (
                ...
                <Card className="text-white bg-dark" style={{height:'400px'}}>
                    <CardBody>
                    <CardTitle tag="h1" style={{margin:'2rem', textAlign:'center'}}>ORDER</CardTitle>
                    <CardTitle tag="h5" >Sub Total: US$ {test.calcSubTotal()} </CardTitle>
                    <CardTitle tag="h5">Taxes: US$ {test.taxes()} </CardTitle>                    
                    <CardTitle tag="h5" style={{marginTop:'2rem'}}>Total: US$ {test.calcTotal() + test.taxes()} </CardTitle>
                    </CardBody>
                    <Button onClick={createOrder} className="btn btn-dark" style={{margin:'2rem'}} >
                    Check Out
                    </Button>
                </Card>
                </div>
